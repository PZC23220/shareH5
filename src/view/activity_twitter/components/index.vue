<template>
    <div class="main">
        ...
        <div class="content">
            ...
            <h2 class="activity_desc">日中両国の多くの人に知ってもらう大チャンス！参加動画が一番<span>「＃Groupyツイートキャンペーン」</span>ハッシュタグで<span>ツイート</span>されたアイドルは、Groupyの公式Twitter、Weiboのヘッダー画像に1ヶ月登場できます！</h2>
