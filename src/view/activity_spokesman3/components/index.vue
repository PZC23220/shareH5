<template>
    <div class="main">
        ...
        <div class="content">
            ...
            <h2 class="activity_title">上位1名は桜シーズン限定のGroupy日本語版イメージガールになって貰います！お花見動画を撮って参加しましょう。</h2>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.p_log('shareActivity_spokesman3_open');
