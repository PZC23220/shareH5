<template>
    <div class="main">
        ...
        <div class="content">
            ...
            <h2 class="activity_title">中国区爱豆专属的Groupy官方采访权争夺战盛大来袭！活动期间获得Like数TOP1的爱豆将接受Groupy采访，并在各大官方平台推荐曝光。马上参与让更多人Get你的萌点~~~</h2>
            <div class="idol-ranking" v-if="!idol.idol_id">
                ...
                <p class="no-ranking-tips" v-if="ranking.length <= 0">活动暂无排名</p>
                <a v-if="ranking.length > 0" @click="get_app('activityshare_activity_ranking')" target="_blank" :href="hrefs" class="download ranking-download">查看更多</a>
            </div>
            <div class="idol-ranking" v-if="idol.idol_id">
                <div class="ranking-one">
                   <div class="img_content">
                    ...
                    <div class="idol_desc">
                        <!-- <p><span><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png"><em>{{Number(ranking.length>0?(idol.gcoin?idol.gcoin:0):0).toLocaleString()}}</em></span><i>{{activity.Gcoin}}</i></p> -->
                ...
                <a @click="get_app('activityshare_idol_support')" target="_blank" :href="hrefs" class="download" style="width: 150px;">守护者可见</a>
            </div>
                ...
                <div class="activity-video_content" v-for="(hot,key) in videos" v-if="key < 10">
                    ...
                    <div class="public_show">
                        ...
                        <div class="Masked2" v-if="hot.publicType == 1">
                            ...
                            <p>成为守护者才能观看视频</p>
                            <a @click="get_app('activityshare_idol_support')" :href="hrefs" target="_blank">成为守护者</a>
                        </div>
                    </div>
                    <div class="video_desc_content">
                        <a @click="get_app('activityshare_idol_support')" :href="hrefs" target="_blank" class="video_option"><span><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png">{{hot.popularity}}</span><div><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/idol/icon_comment.png"> 添加评论</div></a>
                        ...
                        <ul class="comment_list" style="background: #fff;">
                            <div class="comment_total"><span><i>共{{hot.postList.length}}条评论</i></span></div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.p_log('shareActivity_interview_open');
