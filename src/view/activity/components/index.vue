<template>
    <div class="main">
        ...
        <div class="content">
            <img v-if="isOver" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-coke-over.jpg" class="banner">
            <img v-else src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-coke.jpg" class="banner">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.p_log('shareActivity_coke_open');
